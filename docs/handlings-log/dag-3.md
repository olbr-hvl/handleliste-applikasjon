...
For nå hadde jeg en slette knapp ved siden av hver vare i handlelisten men ettersom jeg vil ha flere knapper for å endre posisjonen på varen i handlelisten og muligheten til å endre navnet på varen tenkte jeg å lage en knapp som aktiverer en form for redigeringsmodus.
Først tenkte jeg at du skulle kunne gjøre endringer i redigeringsmodus og så velge om du ville avbryte eller lagre endringene.
Jeg lagde da ett nytt endepunkt som man kunne laste opp endringer på flere varer på en gang, men etter en stund fant jeg ut at jeg sikkert overkompliserte dette.
Etter en del prøving og feiling fant jeg ut at det var lettere å bare gjøre endringene med en gang (altså gå vekk i fra lagre/avbryt).